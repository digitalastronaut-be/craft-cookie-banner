...
class ConsentRecord extends Element {
    ...
    protected static function defineTableAttributes(): array {
        return [
            ...
            'essentialCookies' => ['label' => 'Essential'],
            'functionalCookies' => ['label' => 'Functional'],
            'analyticalCookies' => ['label' => 'Analytical'],
            'advertisementCookies' => ['label' => 'Advertisement'],
            'personalizationCookies' => ['label' => 'Personalization'],
