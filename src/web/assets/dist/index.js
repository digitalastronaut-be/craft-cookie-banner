  ...
  return _createClass(CookieBanner, [{
    ...
    value: function connectedCallback() {
      if (!window.dataLayer && typeof gtag !== "undefined") {
        console.warn("%cCraft CMS plugin warning - Cookie banner\n%cThe dataLayer is not initialized.\nPlease load Google tag manager script first.", "font-weight: bold;", "font-weight: normal;");
        return;
      }
      this.registerElements();
      this.registerEventListeners();
      var existingCookieConsent = JSON.parse((0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.getCookie)("craft-cookie-banner"));
      ...
      document.dispatchEvent(new CustomEvent("cookie-banner:consent-onload", {
        bubbles: true,
        composed: true,
        detail: {
    ...
    value: function acceptAll() {
      ...
      document.cookie = "craft-cookie-banner=".concat(JSON.stringify(this.consent), "; path=/; max-age=31536000; SameSite=Secure");
      var googleConsentV2Object = (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.buildGoogleConsentV2Object)(this.consent);
      gtag("consent", "update", googleConsentV2Object);
      gtag("event", "cookie-banner", this.consent);
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            ...
            case 3:
              session = _context.v;
              _context.n = 4;
              return fetch("actions/cookie-banner/consent-records/create", {
                method: "POST",
                headers: {
    ...
    value: function dispatchConsentUpdate() {
      document.dispatchEvent(new CustomEvent("cookie-banner:consent-update", {
        bubbles: true,
        composed: true,
        detail: {
          consent: this.consent
...
/***/ "./src/web/assets/src/js/consentRecordsGraph.js"
/*!******************************************************!*\
  !*** ./src/web/assets/src/js/consentRecordsGraph.js ***!
  \******************************************************/
(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
var ConsentRecordsGraph = /*#__PURE__*/function (_HTMLElement) {
  function ConsentRecordsGraph() {
    var _this;
    _classCallCheck(this, ConsentRecordsGraph);
    _this = _callSuper(this, ConsentRecordsGraph);
    _this.chartElement = null;
    return _this;
  }
  _inherits(ConsentRecordsGraph, _HTMLElement);
  return _createClass(ConsentRecordsGraph, [{
    key: "connectedCallback",
    value: function () {
      var _connectedCallback = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var response, json, labels, values, accepted;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
            ...
            case 1:
              _context.n = 2;
              return fetch("/actions/cookie-banner/consent-records/get-chart-data");
            case 2:
              response = _context.v;
              _context.n = 3;
            ...
            case 3:
              json = _context.v;
              labels = json.data.map(function (row) {
                return row.date;
              });
              values = json.data.map(function (row) {
                return row.count;
              });
              accepted = json.data.map(function (row) {
                return row.accepted;
              });
              new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](this.chartElement, {
                type: "line",
                data: {
                  labels: labels,
                  datasets: [{
                ...
                options: {
                  ...
                  scales: {
                    ...
                    y: {
                      beginAtZero: true,
                      display: true,
                      suggestedMax: Math.max.apply(Math, _toConsumableArray(values)) + 2,
                      ticks: {
                        stepSize: 1,
                        maxTicksLimit: 8,
...
/***/ "./src/web/assets/src/js/cookiesAndVendorsGraph.js"
/*!*********************************************************!*\
  !*** ./src/web/assets/src/js/cookiesAndVendorsGraph.js ***!
  \*********************************************************/
(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
var CookiesAndVendorsGraph = /*#__PURE__*/function (_HTMLElement) {
  function CookiesAndVendorsGraph() {
    var _this;
    _classCallCheck(this, CookiesAndVendorsGraph);
    _this = _callSuper(this, CookiesAndVendorsGraph);
    _this.cookiesChartElement = null;
    _this.vendorsChartElement = null;
    return _this;
  }
  _inherits(CookiesAndVendorsGraph, _HTMLElement);
  return _createClass(CookiesAndVendorsGraph, [{
    key: "connectedCallback",
    value: function () {
      var _connectedCallback = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var cookiesResponse, _yield$cookiesRespons, cookiesRawData, cookiesChartData, vendorsResponse, _yield$vendorsRespons, vendorsRawData, vendorsChartData, createChartOptions;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
            ...
            case 1:
              _context.n = 2;
              return fetch("/actions/cookie-banner/cookies-and-vendors/get-cookies-chart-data");
            case 2:
              cookiesResponse = _context.v;
              _context.n = 3;
              return cookiesResponse.json();
            case 3:
              _yield$cookiesRespons = _context.v;
              cookiesRawData = _yield$cookiesRespons.data;
              cookiesChartData = {
                labels: cookiesRawData.map(function (item) {
                  return item.label;
                }),
                datasets: [{
                  label: "Cookies",
                  data: cookiesRawData.map(function () {
                    return 1;
                  }),
                  backgroundColor: cookiesRawData.map(function (item) {
              ...
              _context.n = 4;
              return fetch("/actions/cookie-banner/cookies-and-vendors/get-vendors-chart-data");
            case 4:
              vendorsResponse = _context.v;
              _context.n = 5;
              return vendorsResponse.json();
            case 5:
              _yield$vendorsRespons = _context.v;
              vendorsRawData = _yield$vendorsRespons.data;
              vendorsChartData = {
                labels: vendorsRawData.map(function (item) {
                  return item.label;
                }),
                datasets: [{
                  label: "Vendors",
                  data: vendorsRawData.map(function () {
                    return 1;
                  }),
                  backgroundColor: vendorsRawData.map(function (item) {
                    return item.backgroundColor;
                  }),
                  hoverOffset: 4,
                  borderRadius: 4,
              ...
              createChartOptions = function createChartOptions(dataSource, titleText) {
                return {
                  responsive: true,
                  maintainAspectRatio: false,
                  cutout: "65%",
                    ...
                    tooltip: {
                      callbacks: {
                        label: function label(context) {
                          var item = dataSource[context.dataIndex];
                          return item.data;
                        }
                      }
                    }
              ...
              new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](this.cookiesChartElement, {
                type: "doughnut",
                data: cookiesChartData,
                options: createChartOptions(cookiesRawData, "Cookie definitions")
              });
              new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](this.vendorsChartElement, {
                type: "doughnut",
...
/***/ "./src/web/assets/src/js/defenitionStatusChips.js"
/*!********************************************************!*\
  !*** ./src/web/assets/src/js/defenitionStatusChips.js ***!
  \********************************************************/
(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
function _setPrototypeOf(t, e) { return _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, _setPrototypeOf(t, e); }
function _getPrototypeOf(t) { return _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function (t) { return t.__proto__ || Object.getPrototypeOf(t); }, _getPrototypeOf(t); }
var DefenitionStatusChips = /*#__PURE__*/function (_HTMLElement) {
  function DefenitionStatusChips() {
    var _this;
    _classCallCheck(this, DefenitionStatusChips);
    _this = _callSuper(this, DefenitionStatusChips);
    _this.chipElements = [];
    _this.toggleElement = null;
    _this.expanded = false;
    _this.visibleCount = 3;
    return _this;
  }
  ...
  return _createClass(DefenitionStatusChips, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      this.chipElements = _toConsumableArray(this.querySelectorAll(":scope > .status-chip:not(.chip-controls)"));
    ...
    value: function updateVisibility() {
      var _this3 = this;
      this.chipElements.forEach(function (chip, index) {
        if (_this3.expanded || index < _this3.visibleCount) chip.style.display = "";else chip.style.display = "none";
      });
      if (this.toggleElement) {
        var hiddenElementsCount = this.chipElements.length - this.visibleCount;
        this.toggleElement.textContent = this.expanded ? "Show less" : "Show ".concat(hiddenElementsCount, " more");
      }
    }
  }]);
}(/*#__PURE__*/_wrapNativeSuper(HTMLElement));
...
/* harmony import */ var _defenitionStatusChips_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./defenitionStatusChips.js */ "./src/web/assets/src/js/defenitionStatusChips.js");
/* harmony import */ var _consentRecordsGraph_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./consentRecordsGraph.js */ "./src/web/assets/src/js/consentRecordsGraph.js");
/* harmony import */ var _cookiesAndVendorsGraph_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./cookiesAndVendorsGraph.js */ "./src/web/assets/src/js/cookiesAndVendorsGraph.js");
