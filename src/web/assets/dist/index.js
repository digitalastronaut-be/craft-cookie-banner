  ...
  return _createClass(ConsentRecordsGraph, [{
    ...
    value: function () {
      var _connectedCallback = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var response, json, labels, values;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
            ...
            case 1:
              _context.n = 2;
              return fetch("/admin/cookie-banner/consent-records/get-chart-data");
            case 2:
              response = _context.v;
              _context.n = 3;
              return response.json();
...
var CookiesAndVendorsGraph = /*#__PURE__*/function (_HTMLElement) {
  ...
  return _createClass(CookiesAndVendorsGraph, [{
    ...
    value: function () {
      var _connectedCallback = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var cookiesResponse, cookiesRawData, cookiesChartData, vendorsResponse, vendorsRawData, vendorsChartData, createChartOptions;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
            ...
            case 1:
              _context.n = 2;
              return fetch("/admin/cookie-banner/cookies-and-vendors/get-cookies-chart-data");
            case 2:
              cookiesResponse = _context.v;
              _context.n = 3;
              return cookiesResponse.json();
            case 3:
              cookiesRawData = _context.v;
              cookiesChartData = {
              ...
              _context.n = 4;
              return fetch("/admin/cookie-banner/cookies-and-vendors/get-vendors-chart-data");
            case 4:
              vendorsResponse = _context.v;
              _context.n = 5;
              return vendorsResponse.json();
            case 5:
              vendorsRawData = _context.v;
              vendorsChartData = {
