...
function banner() {
  return {
    ...
    logConsent: function logConsent(consentAction) {
      var _this = this;
            ...
            case 0:
              ...
              return fetch("/cookie-banner/consent-records/create", {
                ...
                body: JSON.stringify({
                  ...
                  consentCategories: _this.consent,
...
/***/ "./src/web/assets/src/js/bannerv2.js":
/*!*******************************************!*\
  !*** ./src/web/assets/src/js/bannerv2.js ***!
  \*******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
var CookieBanner = /*#__PURE__*/function (_HTMLElement) {
  function CookieBanner() {
    ...
    _this.manageConsentButtonElements = [];
  ...
  return _createClass(CookieBanner, [{
    ...
    value: function initializeConsentCheckboxes() {
      ...
      this.checkboxes.forEach(function (checkbox) {
        ...
        checkbox.addEventListener("change", function (event) {
          ...
          _this2.updateConsentCheckboxes(property);
        });
      });
    }
  }, {
    key: "updateConsentCheckboxes",
    value: function updateConsentCheckboxes(consentPropertyToUpdate) {
      var _this3 = this;
      var selector = "input[type=\"checkbox\"][data-model=".concat(consentPropertyToUpdate, "]");
      var consentCheckboxesToUpdate = this.querySelectorAll(selector);
      consentCheckboxesToUpdate.forEach(function (checkbox) {
        checkbox.checked = _this3.consent[consentPropertyToUpdate];
      });
    }
  }, {
    ...
    value: function registerElements() {
      ...
      this.manageConsentButtonElements = _toConsumableArray(document.querySelectorAll("[data-manage-consent-button]"));
    }
  }, {
    ...
    value: function registerEventListeners() {
      ...
      this.manageConsentButtonElements.forEach(function (button) {
        button.addEventListener("click", function () {
          return _this4.showBanner();
        });
      });
    }
  }]);
...
/* harmony import */ var _collapse_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./collapse.js */ "./src/web/assets/src/js/collapse.js");
/* harmony import */ var _bannerv2_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./bannerv2.js */ "./src/web/assets/src/js/bannerv2.js");
/* harmony import */ var _banner_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./banner.js */ "./src/web/assets/src/js/banner.js");





alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].prefix("ccb-");
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].plugin(_alpinejs_collapse__WEBPACK_IMPORTED_MODULE_1__["default"]);
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("banner", _banner_js__WEBPACK_IMPORTED_MODULE_4__.banner);
